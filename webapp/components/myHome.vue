    ...
    <div class="home scroll-box">
      ...
      <div class="menu-wrap">
        ...
        <div  class="menu-item bg-purple item-max">
          <i class="icon-choicenessfill icon"></i>
          <div class="item-in">
            <h2>五大特色</h2>
            <h2>保障收益</h2>
          </div>
