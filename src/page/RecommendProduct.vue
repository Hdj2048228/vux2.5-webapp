...
<script>
  import {Cell, Group, GroupTitle, Swipeout, SwipeoutItem, SwipeoutButton, XButton} from 'vux'
  ...
  export default {
    ...
    data() {
      return {
        ...
        list:[
          {title: '奶茶',id: '0',icon: ''},
          {title: 'Zara女装',id: '1',icon: ''},
          {title: 'Hello男装',id: '2',icon: ''},
        ],
      }
    },
    methods: {
      push(item){
        this.$router.push({path: '/RecommendProductEdit?' + item.id})
      },
      del(item,index){
